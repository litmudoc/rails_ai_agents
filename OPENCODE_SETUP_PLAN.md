# OpenCode Setup Plan for rails Project
...
3. [Phase 2: Project AGENT.md](#phase-2-project-agentmd)
...
```bash
mkdir -p ~/.config/opencode/{hooks,commands,agents,skills}
```

### 1.2 Create Global AGENT.md

**File:** `~/.config/opencode/AGENT.md`
...
### 1.3 Create Global opencode.jsonc
...
## Phase 2: Project AGENT.md

### 2.1 Create Project AGENT.md
...
### 2.2 Create Project Local AGENT.md (Optional)

**File:** `./AGENT.local.md` (gitignored)
...
### 3.1 OpenCode Command Hook configuration

**File:** `~/.config/opencode/command-hooks.jsonc`
  ...
  "tool": [
    {
      ...
      "run": "bash ~/.config/opencode/hooks/rails-after-edit.sh",
      "inject": "rails-after-edit.sh (exit {exitCode})\n{stdout}\n{stderr}"
    },
    {
      "id": "rails-after-write",
...
### 3.2 Block Secrets Hook

**File:** `~/.config/opencode/hooks/block-secrets.py`
...
Make executable:
```bash
chmod +x ~/.config/opencode/hooks/block-secrets.py
```

### 3.3 Block Dangerous Commands Hook

**File:** `~/.config/opencode/hooks/block-dangerous-commands.sh`
...
Make executable:
```bash
chmod +x ~/.config/opencode/hooks/block-dangerous-commands.sh
```

### 3.4 Rails After-Edit Hook (Optional)

**File:** `~/.config/opencode/hooks/rails-after-edit.sh`
...
Make executable:
```bash
chmod +x ~/.config/opencode/hooks/rails-after-edit.sh
```
...
**File:** `~/.config/opencode/commands/rails-test.md`
...
**File:** `~/.config/opencode/commands/lint.md`
...
**File:** `~/.config/opencode/commands/security.md`
...
**File:** `~/.config/opencode/commands/generate.md`
...
**File:** `~/.config/opencode/commands/ci.md`
...
**File:** `.opencode/skills/rails-model/SKILL.md`
...
**File:** `.opencode/skills/rails-controller/SKILL.md`
...
**File:** `.opencode/skills/stimulus/SKILL.md`
...
**File:** `~/.config/opencode/agents/rails-reviewer.md`
...
**File:** `~/.config/opencode/agents/rails-test-writer.md`
...
**File:** `~/.config/opencode/agents/rails-migration.md`
...
- [ ] Create `~/.config/opencode/AGENT.md` with global rules
- [ ] Create `~/.config/opencode/opencode.jsonc` with hooks config

### Phase 2: Project AGENT.md
- [ ] Create `./AGENT.md` with project documentation
- [ ] Create `./AGENT.local.md` for personal overrides (optional)
- [ ] Add `AGENT.local.md` to `.gitignore`

### Phase 3: Security Hooks
- [ ] Create `~/.config/opencode/hooks/block-secrets.py`
- [ ] Create `~/.config/opencode/hooks/block-dangerous-commands.sh`
- [ ] Create `~/.config/opencode/hooks/rails-after-edit.sh` (optional)
- [ ] Make all hooks executable (`chmod +x`)
- [ ] Test hooks work correctly

### Phase 4: Custom Commands
- [ ] Create `~/.config/opencode/commands/rails-test.md`
- [ ] Create `~/.config/opencode/commands/lint.md`
- [ ] Create `~/.config/opencode/commands/security.md`
- [ ] Create `~/.config/opencode/commands/generate.md`
- [ ] Create `~/.config/opencode/commands/ci.md`

### Phase 5: Skills
- [ ] Create `.opencode/skills/rails-model/SKILL.md`
- [ ] Create `.opencode/skills/rails-controller/SKILL.md`
- [ ] Create `.opencode/skills/stimulus/SKILL.md`

### Phase 6: Custom Agents
- [ ] Create `~/.config/opencode/agents/rails-reviewer.md`
- [ ] Create `~/.config/opencode/agents/rails-test-writer.md`
- [ ] Create `~/.config/opencode/agents/rails-migration.md`
...
After setup, use these commands in OpenCode:
...
*Plan created for rails-opencode project based on Claude Code V4 guide.*
